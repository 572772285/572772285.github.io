function showTime() { 
	...
	var startDate = new Date(2016, 2, 28);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear XXX:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----XXX2015   2016-03-28</c>"; 
